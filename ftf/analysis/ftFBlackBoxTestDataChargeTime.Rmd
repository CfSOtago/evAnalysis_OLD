...
dFile <- paste0(evParams$dataLoc, "safe/ftfSafeLatestAll.csv.gz") # safe data file 
```
 ...
 * original data made safe using [ftf/dataProcessing/makeSafe.R](https://github.com/CfSOtago/evAnalysis/blob/master/ftf/dataProcessing/makeSafe.R)

## Code and report history

See:

 * https://github.com/CfSOtago/evAnalysis/commits/master/ftf/analysis/ftFBlackBoxTestDataChargeTime.Rmd
